...
class WPPluginWithVueTailwind
{
    ...
    public function renderMenu()
    {
        add_action('admin_menu', function () {
            ...
            $submenu['wpp-plugin-with-vue-tailwind.php']['dashboard'] = [
                'Dashboard',
                'manage_options',
                'admin.php?page=wpp-plugin-with-vue-tailwind.php#/',
            ];
            $submenu['wpp-plugin-with-vue-tailwind.php']['contact'] = [
                'Contact',
                'manage_options',
    ...
    public function renderAdminPage()
    {
        ...
        $WPWVT = apply_filters('WPWVT/admin_app_vars', [
    ...
    public function disableUpdateNag()
    {
        add_action(
            'admin_init',
            function () {
                $disablePages = ['wpp-plugin-with-vue-tailwind.php'];

                if (
                    isset($_GET['page']) &&
                    in_array($_GET['page'], $disablePages)
                ) {
